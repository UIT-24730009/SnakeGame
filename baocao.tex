...
\usepackage{tocloft} % Gói để chỉnh sửa mục lục
\setlength{\cftsecnumwidth}{2.8em} % Tăng khoảng cách giữa số thứ tự và tiêu đề
...
\begin{center}
    \includegraphics[width=0.6\textwidth]{gitconflict1.png}
\end{center}

\begin{table}[h]
    \centering
    \begin{tabular}{c c}
         \includegraphics[width=0.5\textwidth]{gitconflict2.png} & \includegraphics[width=0.5\textwidth]{gitrebase3.png} \\
    \end{tabular}
    % \caption{Caption}
    % \label{tab:my_label}
\end{table}
...
% \section{Hướng mở rộng (Đang nghiên cứu)}
% \subsection{Công nghệ nghiên cứu}
% \begin{itemize}
