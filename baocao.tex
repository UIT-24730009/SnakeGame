...
\begin{itemize}
    \item: Phạm Tiến Anh: bla bla bla
    \item Nguyễn Thanh Minh: Đưa ra các quan điểm thiết kế hình ảnh. Hỗ trợ deploy project
    \item: Trương Anh Vũ: Viết code, phát triển game
\end{itemize}
...
\begin{tabular}{p{5cm} p{5cm} p{5cm}}
    \textbf{Member 4} & \textbf{Member 5} & \textbf{Member 6} \\
    \begin{tabular}{@{}c@{}}
        ho va ten \\
        % \includegraphics[width=5cm]{nhi.jpg}
    \end{tabular}
